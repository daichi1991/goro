...
export const MylistContentsContext = React.createContext({} as {
...
const MylistContentsProvider:React.FC= (children) =>{
    ...
    const [mylistContentsState, setMylistContents] = useState<MylistContentsType>({id:'',name:''});

    return(
        <MylistContentsContext.Provider value={{mylistContentsState, setMylistContents}}>
            {children.children}
