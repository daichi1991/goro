...
const AuthUserProvider: React.FC = (children) =>{
    ...
    return (
        <AuthOperationContext.Provider value={{signUp,signUpConfirm, signIn,signOut, getSignInCheck,postUserInfo}}>
...
export const useGetSignInCheck = () => useContext(AuthOperationContext).getSignInCheck
